...
5)
	...
	media-ctl -d $MEDIANODE -V ''\''tc358743 4-000f'\'':0 [fmt:RGB888_1X24/1920x1080 field:none colorspace:srgb]'
	media-ctl -d $MEDIANODE -V ''\''csi2'\'':0 [fmt:RGB888_1X24/1920x1080 field:none colorspace:srgb]'
	media-ctl -d $MEDIANODE -V ''\''csi2'\'':4 [fmt:RGB888_1X24/1920x1080 field:none colorspace:srgb]'
	v4l2-ctl -v width=1920,height=1080,pixelformat=RGB3
	echo RGB888_1X24 1920x1080 set
;;
6)
	echo 6 > /sys/module/tc358743/parameters/resolution
	if [ $? -ne 0 ]
	then
		exit 1
	fi
	media-ctl -d $MEDIANODE -V ''\''tc358743 4-000f'\'':0 [fmt:RGB888_1X24/3840x2160 field:none colorspace:srgb]'
	media-ctl -d $MEDIANODE -V ''\''csi2'\'':0 [fmt:RGB888_1X24/3840x2160 field:none colorspace:srgb]'
	media-ctl -d $MEDIANODE -V ''\''csi2'\'':4 [fmt:RGB888_1X24/3840x2160 field:none colorspace:srgb]'
	v4l2-ctl -v width=3840,height=2160,pixelformat=RGB3
	echo RGB888_1X24 3840x2160 set
;;
*)
